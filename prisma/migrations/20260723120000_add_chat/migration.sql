-- CreateEnum
CREATE TYPE "ChatConversationType" AS ENUM ('DIRECT', 'CHANNEL');
...
-- CreateIndex
CREATE INDEX "ChatConversation_type_isPrivate_idx" ON "ChatConversation"("type", "isPrivate");

-- CreateIndex
CREATE INDEX "ChatConversation_audienceRole_idx" ON "ChatConversation"("audienceRole");
